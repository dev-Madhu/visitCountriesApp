  ...
  onClickVisited = id => {
    ...
    this.setState(prevState => ({
      visitedList: [
        ...
        ...prevState.countriesList.filter(each => each.id === id),
      ],
    }))
  }
  ...
  render() {
    ...
    return (
      <div className="main-container">
        <div className="country-visit-board">
        ...
        <div className="visited-countries">
          ...
          {visitedCountries ? (
            <div className="no-countries">
              <p className="country">No Countries Visited Yet!</p>
            </div>
          ) : (
            <ul className="visited-list">
              {visitedList.map(each => (
                <VisitedCard
                  visitedDetails={each}
                  key={each.id}
                  deleteVisitedPlace={this.deleteVisitedPlace}
                />
              ))}
            </ul>
          )}
